...
export default function Auth() {
  ...
  const handleSignup = async () => {
    try {
      ...
      setOtpData({ ...otpData, email: signup.email });
      setStep("otp");
  ...
  const handleReset = async () => {
    try {
      ...
      await AuthAPI.post("/auth/reset-password", otpData);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 relative">
      ...
      <div className="absolute top-5 left-1/2 -translate-x-1/2 z-50 w-[320px]">
        {error && <div className="toast error animate-pulse">❌ {error}</div>}
        {message && <div className="toast success animate-pulse">✔ {message}</div>}
      </div>
        ...
        <div className="w-1/2 p-10 flex flex-col justify-center">
          ...
          {mode === "login" && step === "form" && (
            <>
              ...
              <button className="google-btn mt-3" onClick={handleGoogle}>
                Login with Google
              </button>
          ...
          {mode === "signup" && step === "otp" && (
            <>
              ...
              <button className="btn" onClick={handleVerifySignup} disabled={loading}>
          ...
          {mode === "forgot" && step === "form" && (
            <>
              ...
              <p className="text-blue-500 mt-3 cursor-pointer"
